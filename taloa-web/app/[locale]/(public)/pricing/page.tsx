...
// MVP: lancar so Free, Plus e Club (Exotic Club / Family ficam so na estrutura).
...
export default async function PricingPage({
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-8 px-4 py-10">
          ...
          return (
            <div
              ...
              className={`relative flex flex-col rounded-card bg-white p-6 shadow-sm ${
                isClub ? "ring-2 ring-taloa-primary" : "border border-slate-200"
              }`}
            >
              {isClub && (
      ...
      {/* Premium Tag avulsa (pagamento unico) */}
      {premiumTag && (
